...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: spacing.lg, paddingTop: spacing.lg, paddingBottom: 0, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  h1: { ...text.h2 },
  ...
  tabs: { paddingHorizontal: spacing.lg, paddingTop: spacing.sm, paddingBottom: spacing.sm, gap: spacing.sm, alignItems: "center" },
